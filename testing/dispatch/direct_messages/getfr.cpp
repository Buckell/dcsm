...
struct getfr_interface final : dcsm::dispatch_interface {
    bool received = false;
...
TEST(dispatch_direct_messages, getfr) {
    getfr_interface itf;
    ...
    dcsm::message_header const header { 0x0006, static_cast<uint16_t>(data.size() - 5) };
