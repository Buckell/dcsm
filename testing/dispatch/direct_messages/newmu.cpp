...
struct newmu_interface final : dcsm::dispatch_interface {
    bool received = false;
...
TEST(dispatch_direct_messages, newmu) {
    newmu_interface itf;
    ...
    dcsm::message_header const header { 0x0007, static_cast<uint16_t>(data.size() - 5) };
