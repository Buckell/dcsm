...
struct listmu_interface final : dcsm::dispatch_interface {
    bool received = false;
...
TEST(dispatch_direct_messages, listmu) {
    listmu_interface itf;
    ...
    dcsm::message_header const header { 0x0008, static_cast<uint16_t>(data.size() - 5) };
