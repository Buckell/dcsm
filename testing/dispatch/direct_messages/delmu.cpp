...
struct delmu_interface final : dcsm::dispatch_interface {
    bool received = false;
...
TEST(dispatch_direct_messages, delmu) {
    delmu_interface itf;
    ...
    dcsm::message_header const header { 0x0009, static_cast<uint16_t>(data.size() - 5) };
